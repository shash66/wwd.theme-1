 ...
 *   The form state.
 */
function wwd_theme_form_system_theme_settings_alter(&$form, &$form_state) {

	$form['mtt_settings'] = array(
		'#type' => 'fieldset',
		'#title' => t('WWD Theme Settings'),
		'#collapsible' => FALSE,
		'#collapsed' => FALSE,
	);
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_state'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_state', 'wwd_theme'),
	);
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_menu_switchwidth'] = array(
	...
	'#default_value' => theme_get_setting('responsive_menu_switchwidth', 'wwd_theme'),
	);
	...
	'#default_value' => theme_get_setting('responsive_menu_topoptiontext', 'wwd_theme'),
	);
