 ...
 */
function wwd_theme_html_head_alter(&$head_elements) {
 ...
 */
function wwd_theme_process_html(&$variables) {
 ...
 */
function wwd_theme_process_page(&$variables) {
...
function wwd_theme_page_alter($page) {
...
function wwd_theme_breadcrumb($variables) {
...
if (theme_get_setting('responsive_menu_state')) {
	...
	drupal_add_js(drupal_get_path('theme', 'wwd_theme') .'/js/jquery.mobilemenu.js');
